...
libs_softmmu=-lpixman-1 -lutil -lnuma -lpng16 -lz -lnettle -lgnutls  -llzo2 -lsnappy -lrdmacm -libverbs -libumad -lfdt -lspice-server
GIT=git
...
VERSION=3.1.0
PKGVERSION=
SRC_PATH=/home/mobileos/qemu-sgx
TARGET_DIRS=x86_64-softmmu
BUILD_DOCS=yes
CONFIG_STAMP=_f0305476c51f7b81d069bf268c235bafda261fd7
CONFIG_MODULES=y
CONFIG_X11=y
X11_CFLAGS=
X11_LIBS=-lX11
...
VTE_LIBS=-lvte-2.91 -lgtk-3 -lgdk-3 -lpangocairo-1.0 -lpango-1.0 -latk-1.0 -lcairo-gobject -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lgobject-2.0 -lglib-2.0 -lz -lgnutls
CONFIG_LINUX_AIO=y
CONFIG_ATTR=y
CONFIG_VIRTFS=y
CONFIG_VHOST_SCSI=y
...
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg -iquote $(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/mobileos/qemu-sgx/build/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include
AUTOCONF_HOST := 
...
LIBS+=-L$(BUILD_DIR)/capstone -lcapstone -lm -ltcmalloc -lz -Wl,--export-dynamic -lgmodule-2.0 -pthread -lglib-2.0 -lgthread-2.0 -pthread -lglib-2.0  -lrt
LIBS_TOOLS+=-lcap-ng -lnettle -lgnutls 
PTHREAD_LIB=
EXESUF=
DSOSUF=.so
LDFLAGS_SHARED=-shared
LIBS_QGA+=-lm -Wl,--export-dynamic -lgmodule-2.0 -pthread -lglib-2.0 -lgthread-2.0 -pthread -lglib-2.0  -lrt
TASN1_LIBS=-ltasn1
TASN1_CFLAGS=
